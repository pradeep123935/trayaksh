  ...
  return (
    <footer className="relative w-full bg-[#061e1c] text-white overflow-hidden">
      ...
      <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 sm:pt-12 lg:pt-14 pb-3 sm:pb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-6 lg:gap-10 pb-4 text-center md:text-left">
          
          {/* Column 1: Brand & Logo (4/12) */}
          <div className="lg:col-span-4 space-y-3.5 flex flex-col items-center md:items-start">
            ...
            <p className="text-xs sm:text-sm text-slate-300 font-normal leading-relaxed max-w-sm mx-auto md:mx-0">
          ...
          <div className="lg:col-span-3 space-y-3 flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-slate-300 flex flex-col items-center md:items-start">
          ...
          <div className="lg:col-span-2 space-y-3 flex flex-col items-center md:items-start">
            <h3 className="text-xs font-bold tracking-widest text-[#2dd4bf] uppercase">
              NAVIGATION
            </h3>
            <ul className="space-y-2 text-xs sm:text-sm text-slate-300 flex flex-col items-center md:items-start">
          ...
          <div className="lg:col-span-3 space-y-3 flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-2.5 text-xs sm:text-sm text-slate-300 flex flex-col items-center md:items-start">
